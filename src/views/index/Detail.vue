              ...
              <div class="count-item flex-view" @click="share()">
                ...
                <div class="count-box flex-view">
                  ...
                  <div class="count-num-box">
                    ...
                    <el-icon class="mg-l"><Share /></el-icon>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="buy-way hidden-sm">
            ...
            <div class="flex-view">
              <div class="buy-way-item" style="">
                ...
                <div class="price">
                  <a-popconfirm title="确定借阅？" ok-text="是" cancel-text="否" @confirm="handleBorrow(detailData)">
          ...
          <div class="main-content">
            ...
            <div class="thing-comment" :class="selectTabIndex > 0 ? '' : 'hide'">
              ...
              <div class="publish flex-view">
                <el-icon class="mine-img"><Avatar /></el-icon>
              ...
              <div class="comments-list">
                <div class="comment-item" v-for="item in commentData">
                  <div class="flex-item flex-view">
                    <el-icon class="avator"><Avatar /></el-icon>
                    <div class="person">
...
import { Avatar, Plus, Collection, Share } from '@element-plus/icons-vue'
...
onMounted(() => {
  bookId.value = route.query.id.trim()
  getBookDetail()
  getRecommendThing()
  getCommentList()
})
...
const getBookDetail = () => {
  bookInfo.value = getBookInfo(bookId.value).data;
}

const collect = () => {
  addCollect({ thingId: bookId.value });
  getBookDetail()
}

const unCollect = () => {
  deleteCollect({ thingId: bookId.value });
  getBookDetail()
}
...
const sendComment = () => {
  leaveComment(commentRef.value);
}

const getCommentList = () => {
  commentData.value = getCommentByBookId(bookId.value).data;
}
